...
- Mappings: `docs/mappings/README.md`, `docs/mappings/reg-mapping.md`, `docs/mappings/irn-mapping.md`, `docs/mappings/suse-csf-mapping.md`, `docs/mappings/techsov-catalogue.md`, `docs/mappings/tmforum-camara.md`, `docs/mappings/aws-minimal-subset.md`, `docs/mappings/vcluster.md`, `docs/mappings/eu-cloud-provider-selection-matrix.md`, `docs/mappings/eu-sovereignty-assurance-matrix.md`
