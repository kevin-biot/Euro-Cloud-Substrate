...
- Training evidence: Training runs record dataset hashes/IDs, dataset manifest (DSBOM), data‑use posture, exclusion policy snapshot, and dataset policy bindings.
...
- Training decision binding: Training events include policy/authority snapshots and `governance_phase`.
