...
| RES-4.4 — résilience télécom/connectivité | Stay accessible despite telecom failures | PHY + CRP + EVID | CRP-6; (future) PHY profile | Declared connectivity dependencies; single-path detection; partition scenarios; test evidence | **gap (needs PHY workstream)** |
