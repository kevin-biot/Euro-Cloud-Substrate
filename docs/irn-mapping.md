...
| RES-5.1 — dépendance supply chain extra-territoriale | Reduce exposed supply chain dependencies | SUP + EVID | SUP deep-dive; evidence catalog | SBOM; build provenance; upstream disclosure; opaque dependency fails conformance | **partially-covered** |
