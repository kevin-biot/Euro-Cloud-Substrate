...
- `ops.md` — Human/operations invariants (runbooks, role redundancy, access independence, operational evidence)
...
- Data-space alignment notes: `docs/mappings/gaia-x/README.md` (non-normative).
