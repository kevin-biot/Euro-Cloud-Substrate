...
Refusal-specific fields and verifier checks are defined in `docs/evidence/refusal-semantics.md`.
...
```json
{
  ...
  "properties": {
    ...
    "correlation_id": { "type": "string" },
    "sequence": { "type": "integer" },
    "route_intent": { "enum": ["agent.invoke", "ml.inference.route", "ml.training.route", "data.transfer"] },
